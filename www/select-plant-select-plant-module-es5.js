...
var SelectPlantPageModule = /** @class */ (function () {
    function SelectPlantPageModule() {
    }
...
var SelectPlantPage = /** @class */ (function () {
    function SelectPlantPage(navCtrl, fetch, config, notificationsService, actionSheetCtrl, modalCtrl, userService) {
    ...
    SelectPlantPage.prototype.ngOnInit = function () {
    ...
    SelectPlantPage.prototype.show = function (prod) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var lang, buttons, x, act;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        lang = this.config.translate.currentLang;
                        ...
                        if (prod.categories) {
                            prod.categories.forEach(function (element) {
                                if (element.url) {
                                    buttons.push({
                                        text: lang == 'en' ? element.name_en : element.name_ar,
                                        handler: function () {
                                            _this.go_detect(element);
                                        }
                                    });
                                }
                            });
                        }
                        if (!prod.vip) return [3 /*break*/, 1];
    ...
    SelectPlantPage.prototype.go_detect = function (prod) {
        this.navCtrl.navigateForward(['detect'], { queryParams: prod });
    };
    SelectPlantPage.prototype.subscribe = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SelectPlantPage.ctorParameters = function () { return [
...
//# sourceMappingURL=select-plant-select-plant-module-es5.js.map