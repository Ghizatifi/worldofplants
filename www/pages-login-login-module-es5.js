...
var LoginPage = /** @class */ (function () {
    function LoginPage(iab, fb, config, fetch, navCtrl, userService, popover, actionSheet, utils) {
        this.iab = iab;
        this.fb = fb;
        this.config = config;
        this.fetch = fetch;
    ...
    LoginPage.prototype.toggleShowReg = function () {
        this.showPasswordReg = !this.showPasswordReg;
    };
    LoginPage.prototype.toggleShowConf = function () {
        this.showPasswordRegConf = !this.showPasswordRegConf;
    };
    LoginPage.prototype.change = function (ev) {
    ...
    LoginPage.prototype.get_plants = function () {
                ...
                switch (_a.label) {
                    case 0:
                        if (this.userService.all_plants.length > 0)
                            return [2 /*return*/];
                        header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpHeaders"]().set("Authorization", "Bearer " + this.config.token);
                        return [4 /*yield*/, this.fetch.get('plants', header)
                                .then(function (res) {
                                var data;
                                if (res) {
                                    data = res.data;
                                    _this.userService.all_plants = data.plants;
                                    _this.userService.all_sizes = data.size;
                                    _this.userService.terms = data.config.terms;
            ...
            this.fetch.post('auth/login', params)
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    if (data.access_token) {
                        ...
                        console.log("data ", data);
                        ph = data.user.phone[0] + data.user.phone[1] + data.user.phone[2];
    ...
    LoginPage.prototype.isEmail = function (email) {
    ...
    LoginPage.prototype.preformRegister = function (access_token, role_id, user_id) {
        ...
        this.navCtrl.navigateRoot(['select-plants'], { queryParams: { role_id: role_id } });
    };
    LoginPage.prototype.preformLogin = function (access_token, role_id, user_id) {
        this.config.token = access_token;
        this.config.role_id = role_id;
        // this.config.user.id = user_id;
        if (!this.config.user.token) {
    ...
    LoginPage.prototype.getUserDetailf = function (userid) {
    };
    LoginPage.prototype.b64toBlob = function (b64Data, contentType, sliceSize) {
    ...
    LoginPage.prototype.changeCountry = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var header, actionSheet, _loop_1, this_1, i;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        _loop_1 = function (i) {
                            if (this_1.lang == 'ar') {
                                actionSheet.buttons.push({ 'text': this_1.CountryJson[i].name + '  ' + this_1.CountryJson[i].dial_code, role: 'destructive',
                                    handler: function () {
                                        _this.selectCountry(i);
                                    }
                                });
                            }
                            else {
                                actionSheet.buttons.push({ 'text': this_1.CountryJson[i].name_en + '  ' + this_1.CountryJson[i].dial_code, role: 'destructive',
                                    handler: function () {
                                        _this.selectCountry(i);
                                    }
                                });
                        ...
                        this_1 = this;
                        for (i = 0; i < this.CountryJson.length; i++) {
                            _loop_1(i);
                        }
    ...
    LoginPage.prototype.selectCountry = function (index) {
    ...
    LoginPage.prototype.acceptTermsFunc = function () {
        console.log("acc ", this.acceptTerms);
        this.acceptTerms = !this.acceptTerms;
    };
    LoginPage.prototype._terms = function () {
        var browser = this.iab.create('http://slyd4r.net/privacy-policy');
    };
    LoginPage.prototype.terms = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        modal = this.popover.create({
