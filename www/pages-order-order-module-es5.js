...
var OrderPage = /** @class */ (function () {
    function OrderPage(route, fetch, config, modalCtrl, popoverController, userService, navCtrl) {
        this.route = route;
        this.fetch = fetch;
        this.config = config;
    ...
    OrderPage.prototype.getOrderInfo = function () {
        var _this = this;
    ...
    OrderPage.prototype.total = function () {
        var price = 0;
        for (var index in this.orderInfo.items) {
            price += this.orderInfo.items[index].quantity * this.orderInfo.items[index].price;
        }
        return price.toFixed(1);
    };
    OrderPage.prototype.discount = function () {
    ...
    OrderPage.prototype.all = function () {
        return ((this.total() - (this.discount() ? this.discount() : 0)) + (this.orderInfo.d_price ? this.orderInfo.d_price : 0)).toFixed(1);
    };
    OrderPage.prototype.order_done = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpHeaders"]().set("Authorization", "Bearer " + this.config.token);
    ...
    OrderPage.prototype.goToMap = function () {
        this.navCtrl.navigateForward(['driver-map'], { queryParams: this.orderInfo });
    };
    OrderPage.prototype.check_rate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    OrderPage.prototype.ratePop = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        modal = this.popoverController.create({
                    ...
                    case 1:
                        (_a.sent()).onDidDismiss().then(function (data) {
                            ...
                            if (data.data && data.data.comment && data.data.stars) {
                                _this.rate(data.data.stars, data.data.comment);
                            }
                            else {
                                _this.goHome();
                            }
    ...
    OrderPage.prototype.rate = function (stars, comment) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var payload, headers;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.fetch.post('store/' + 1 + '/rate/add', payload, headers) //1 is the store id
                    .subscribe(function (res) {
                    _this.fetch.errorToast("تم التقييم بنجاح");
                    console.log("res ", res);
                    var data;
                    if (res.status) {
                        data = res.data;
    ...
    OrderPage.prototype.goHome = function () {
        this.navCtrl.navigateRoot("stores");
    };
    OrderPage.prototype.cancelOrder = function () {
