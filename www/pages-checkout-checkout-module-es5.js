...
var CheckoutPage = /** @class */ (function () {
    function CheckoutPage(fetch, config, modalCtrl, alertCtrl, navCtrl, utils) {
        this.fetch = fetch;
        this.config = config;
    ...
    CheckoutPage.prototype.getAddresses = function () {
    ...
    CheckoutPage.prototype.testCoupon = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var headers;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.fetch.post('auth/coupon/use/' + this.couponText, null, headers)
                    .subscribe(function (coupon) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CheckoutPage.prototype.total = function () {
        var price = 0;
        for (var index in this.config.cart) {
            price += this.config.cart[index].quantity * this.config.cart[index].total_price;
        }
        return price;
    };
    CheckoutPage.prototype.discount = function () {
        if (this.coupon)
    ...
    CheckoutPage.prototype.placeOrder = function () {
        ...
        var date = new Date();
        var date_2 = date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate() + ' ' + date.getHours() + ':' + date.getMinutes() + ':00';
    ...
    CheckoutPage.prototype.getDeliveryCost = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var link, headers;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                console.log(this.address);
                link = 'auth/area/cost/' + this.address.area_id;
                headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]().set("Authorization", "Bearer " + this.config.token);
