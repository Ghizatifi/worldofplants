...
var InstructionDetailsPageModule = /** @class */ (function () {
    function InstructionDetailsPageModule() {
    }
    ...
    return InstructionDetailsPageModule;
}());
...
var InstructionDetailsPage = /** @class */ (function () {
    function InstructionDetailsPage(fetch, config, navCtrl, route, utils) {
        this.fetch = fetch;
        this.config = config;
    ...
    InstructionDetailsPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.route.queryParams.subscribe(function (res) {
                            _this.plant_id = res.plant_id;
                            _this.disease_id = res.disease_id;
                        })];
                    case 1:
                        _a.sent();
                        this.loadResult();
    ...
    InstructionDetailsPage.prototype.pop = function () {
        this.navCtrl.back();
    };
    InstructionDetailsPage.prototype.loadResult = function () {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        var route = this.disease_id ? 'disease/' + this.disease_id : "plant/" + this.plant_id;
        this.fetch.get(route, headers)
            ...
            if (res.status) {
                ...
                if (data.irrigation_ar || data.irrigation_en) {
                    _this.extras.push({ icon: _this.assets.humidity, title: _this.utils.translator("irrigation"), body: _this.config.lang == 'ar' ? data.irrigation_ar : data.irrigation_en });
                }
                if (data.light_ar || data.light_en) {
                    _this.extras.push({ icon: _this.assets.sun, title: _this.utils.translator("light"), body: _this.config.lang == 'ar' ? data.light_ar : data.light_en });
                }
                if (data.tempreture_ar || data.tempreture_en) {
                    _this.extras.push({ icon: _this.assets.tempreture, title: _this.utils.translator("tempreture"), body: _this.config.lang == 'ar' ? data.tempreture_ar : data.tempreture_en });
                }
            }
            else {
            ...
            _this.result = data;
            _this.products = _this.disease_id ? data.medicines : data.products;
    ...
    InstructionDetailsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-instructions-instruction-details-instruction-details-module-es5.js.map