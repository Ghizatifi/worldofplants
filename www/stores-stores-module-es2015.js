...
let StoresPage = class StoresPage {
    constructor(config, fetch, navCtrl, actionSheetCtrl, route, userService, modalCtr) {
        this.config = config;
        this.fetch = fetch;
    ...
    get_products() {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set("Authorization", "Bearer " + this.config.token);
