...
var MorePage = /** @class */ (function () {
    function MorePage(navCtrl, alertCtrl, config, share, modalCtrl, fetch, actionSheet, iab, utils) {
    ...
    MorePage.prototype.openPage = function (page, pageObject) {
        if (pageObject === void 0) { pageObject = null; }
        if (page == 'logout') {
            this.logout();
            return;
        }
    ...
    MorePage.prototype.shareTo = function () {
    ...
    MorePage.prototype.openLink = function (link) {
    ...
    MorePage.prototype.setLang = function () {
    ...
    MorePage.ctorParameters = function () { return [
