...
var CategoriesPage = /** @class */ (function () {
    function CategoriesPage(config, fetch, navCtrl) {
        this.config = config;
        this.fetch = fetch;
    ...
    CategoriesPage.prototype.get_categories = function () {
        var _this = this;
    ...
    CategoriesPage.prototype.showCategoryProducts = function (cat) {
