...
var CartPage = /** @class */ (function () {
    function CartPage(navCtrl, config, fetch, modalCtr, utils) {
    ...
    CartPage.prototype.haveMoreThanOneItem = function () {
        return Object.keys(this.config.cart).length > 0;
    };
    CartPage.prototype.total = function () {
        var total = 0;
        for (var _i = 0, _a = this.config.cart; _i < _a.length; _i++) {
            var item = _a[_i];
            total += (item.quantity * item.total_price);
        }
        return total;
    };
    CartPage.prototype.openProduct = function (product) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        modal = this.modalCtr.create({
