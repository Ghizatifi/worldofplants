...
let CancelPage = class CancelPage {
    constructor(userService, fetch, config, utils, route, navCtrl) {
    ...
    submit() {
        ...
        this.fetch.post(lnk, payload, headers).subscribe((res) => {
            this.loading = false;
            if (res.status) {
...
//# sourceMappingURL=pages-order-cancel-cancel-module-es2015.js.map