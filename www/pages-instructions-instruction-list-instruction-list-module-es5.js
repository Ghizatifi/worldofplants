...
var InstructionListPageModule = /** @class */ (function () {
    function InstructionListPageModule() {
    }
    ...
    return InstructionListPageModule;
}());
...
var InstructionListPage = /** @class */ (function () {
    function InstructionListPage(config, fetch, routeA, navCtrl) {
        this.config = config;
        this.fetch = fetch;
        this.routeA = routeA;
    ...
    InstructionListPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.routeA.queryParams.subscribe(function (res) {
                            console.log("res is ", res);
                            if (res.is_plants == true) {
                                console.log("plants true");
                                _this.route = "plants_instructions";
                                _this.is_plants = true;
                            }
                            else {
                                console.log("plants flase");
                                _this.route = "diseases"; //disaese list api
                            }
                        })];
                    case 1:
                        _a.sent();
    ...
    InstructionListPage.prototype.loadList = function () {
        var _this = this;
        this.loaded = true;
        ...
        this.fetch.get(this.route, headers)
            ...
            _this.list = res.data;
            if (!_this.is_plants) {
                _this.list.forEach(function (disease) {
    ...
    InstructionListPage.prototype.details = function (id) {
        if (this.is_plants)
    ...
    InstructionListPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-instructions-instruction-list-instruction-list-module-es5.js.map